...
const rawFirebaseConfig = import.meta.env.REACT_APP_FIREBASE_CONFIG || '{}';
...
export const initialAuthToken: string | null = import.meta.env.REACT_APP_INITIAL_AUTH_TOKEN || null;
// Ensure appId is explicitly a string
export const appId: string = import.meta.env.REACT_APP_APP_ID || 'textile-biz-manager';
